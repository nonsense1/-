...
//        NSLog(@"%@",user);
        ...
        self.consumption.text = [userInfo objectForKey:@"paid_accumulatie"];
        self.balance.text = [userInfo objectForKey:@"paid_remain"];
        ...
        self.cumulativePoints.text = [userInfo objectForKey:@"score_accumulatie"];
        self.currentPoints.text = [userInfo objectForKey:@"score"];
        self.cumulativeExchange.text = [userInfo objectForKey:@"money_accumulatie"];
