...
-(void)creatUI{
    ...
    UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(50, self.view.frame.size.height+700,self.view.frame.size.width-100, 50)];
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    _myTableView.contentSize= CGSizeMake(0,  self.view.frame.size.height+750+50);
